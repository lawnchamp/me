    ...
    <div className="flex ">
      ...
      <div className="max-w-md px-8 py-12 mx-auto sm:max-w-xl lg:max-w-full lg:w-1/2 lg:py-24 lg:px-12">
        <div className="xl:max-w-lg xl:ml-auto">
          ...
          <div className="my-4 text-sm font-bold tracking-widest text-gray-600 uppercase">
            Full Stack Engineer • Washington DC
          </div>
          <p className="text-gray-600 sm:mt-4 sm:text-xl">
            Building web apps with
            <b className="pl-1 font-semibold text-green-600">Ruby on Rails</b>,
            <b className="pl-1 font-semibold text-green-600">React</b>, and
            <b className="pl-1 font-semibold text-green-600">Vue</b> since 2015
          </p>
